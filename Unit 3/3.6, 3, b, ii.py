# Name: Fady Elsayed
# Date: Mar 20 2021
# File Name: 3.6, 3, b, ii.py
# Description: A program to generates the sum of 3 dice and checks and
# prints which ones are have a sum between 7 and 11.
...
for die1 in range(1,6):
   for die2 in range(1,6):
      for die3 in range(1,6):
         ...
         if (sum_dice > 7) and (sum_dice < 11):
            total += 1
            print(die1, die2, die3)

# Output: prints the total possible rolls that have a sum from 7 to 11.
print("There are", total, "possible rolls that have a sum from 7 to 11.")
